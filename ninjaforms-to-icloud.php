        ...
        <form method="post">
            ...
            <table class="form-table">
                <tr>
                    ...
                    <td><input type="email" id="icloud_email" name="icloud_email"
                ...
                <tr>
                    ...
                    <td><input type="password" id="icloud_password" name="icloud_password"
...
VCF;
        ...
        $vCardData .= "\nitem1.X-ABADR:au";
        $vCardData .= "\nitem2.X-ABRELATEDNAMES;TYPE=pref:Website contact";
        $vCardData .= "\nitem2.X-ABLABEL:Source";
    ...
    <table id="support" class="form-table cptui-table">
        <tr>
            <td class="outer">
                ...
                <p>Go to "Ninja to Apple Contacts > Settings" and enter your iCloud email and app-specific password. If
                    your Apple ID uses a non-icloud.com email address, you will need to use icloud.com or me.com alias
                    as the iCloud email.
                <p>
                <p>Submit ‘Get a Quote’ form at the homepage (https://finestrasa.com.au/#contact). It should add contact
                    to your iCloud Contacts.
                <p>
                <h2><?php esc_html_e('Notes', 'ninjaforms-to-icloud'); ?></h2>
                <p>Each form has unique form input IDs. If you edit/change input ID then data might not be captured.
                <p>
                <!-- p>SOURCE custom field of the vCard is invisible and can be seen when exporting vCard.
                <p //-->
            </td>
        </tr>
    </table>
